...
import fonar from "./assets/icons/Group 178.png";
function App() {
  return (
    <>
      <body className="bg-blue-600">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <div className="text-white lg:w-1/2 space-y-6">
              ...
              <p className="text-gray-300 max-w-md">
                ...
                Nulla sapien lectus sit tristique rhoncus, nisi, <br />{" "}
        ...
        <main className="bg-gray-50 min-h-screen py-16 px-8">
          <section className="grid grid-cols-3 md:grid-cols-6 gap-6 mb-16 items-center">
            ...
            <div className="flex justify-center shadow-lg ml-2.5	">
              <img src={ola} alt="Ola" className="w-40 object-contain m-4" />
            </div>
            <div className="flex justify-center shadow-lg ml-2.5	">
              <img
                src={microsoft}
            ...
            <div className="flex justify-center shadow-lg">
              <img src={fedx} alt="fedx" className="w-40 object-contain m-2" />
            </div>
            <div className="flex justify-center shadow-lg">
              <img
                src={walmart}
          ...
          <section className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="md:w-1/2 text-center md:text-left ml-30 ">
              ...
              <p className="text-gray-600 mb-6 text-xl">
                ...
                donec <br />
                gravida feugiat neque, ipsum faucibus. Pharetra vel suspendisse
                mi <br />
          ...
          <section class="h-[653px] w-full bg-[url('./assets/images/Group177.png')] bg-cover">
            <div class="flex item-center justify-center h-full">
              <div class="flex items-center gap-[30px]">
                <div class="w-[261px] h-[371px] bg-[url('./assets/images/Rectangle18.png')] bg-cover flex justify-center pt-[96px]">
                  <div>
          ...
          {/* <section >
            <div className="mt-[84px] w-[358px] h-[199px] bg-[#FDEEE7] p-[24px]  hover:bg-[#4252CF]  border-double border-4 border-sky-500 ">
              <img src={fonar} alt="" />
              <h2 className=" text-[20px] leading-[32px] mt-[20px] text-slate-800  ">
                Creative Ideas
              </h2>
              <p className=" mt-[9px] mb-[35px] text-slate-800  ">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                donec gravida
              </p>
            </div>
          ...
          <section className="bg-[#EBEDFF] h-[501-px]">
            <PageContainer>
              <div>
          ...
          <section className="bg-white pt-[676-px]">
            <div className="w-full bg-[#FDEEE7] h-[405px]"></div>
          </section>
        </main>
      </body>
    </>
